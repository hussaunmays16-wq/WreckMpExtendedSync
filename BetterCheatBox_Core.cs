...
namespace WreckMPExtendedSync
{
	...
	public class WreckMPExtendedSync : Mod
	{
		...
		private void Mod_OnLoad()
		{
			...
			ModConsole.Print("<color=green>[WreckMP Extended Sync v3.9.0]</color> Ядро синхронизации успешно запущено (Режим честного P2P)!");
		}
	}
	...
	public static class FileLogger
	{
		...
		public static void Init()
		{
			try
			{
				...
				WriteLine("==================================================", "INFO");
				WriteLine("SESSION START v3.9.0 | " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), "INFO");
				WriteLine("==================================================", "INFO");
			}
			catch (Exception ex)
			{
	...
	public class ExtendedSyncDebugHUD : MonoBehaviour
	{
		...
		private void OnGUI()
		{
			try
			{
				...
				GUILayout.Label("<color=#00ffcc><b>★ WRECKMP EXTENDED NETWORK SYNC v3.9.0 ★</b></color>");
